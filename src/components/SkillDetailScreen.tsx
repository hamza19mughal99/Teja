        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8 xl:px-12">
          ...
          <div className="py-6 border-b border-gray-100">
            ...
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 lg:w-14 lg:h-14 rounded-full bg-gradient-to-br from-purple-400 to-pink-400 flex items-center justify-center text-white">
                {skill.provider.avatar}
              </div>
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  <p className="font-semibold text-gray-900">{skill.provider.name}</p>
                  {skill.provider.verified && (
          ...
          {/* Availability */}
          <div className="py-6 border-b border-gray-100">
            <h3 className="text-lg lg:text-xl font-semibold text-gray-900 mb-3">Availability</h3>
          ...
          <div className="py-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex items-center gap-2">
                <div className="flex">
                  {renderStars(Math.round(skill.rating))}
                </div>
                <span className="font-semibold text-gray-900">{skill.rating}</span>
                <span className="text-sm text-gray-500">({skill.reviewCount})</span>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto flex items-center gap-4">
          <div className="flex items-center gap-6 flex-1">
            <div className="flex items-center gap-2 text-gray-600">
              ...
              <span className="font-semibold">Duration: {skill.creditHours} hr</span>
            </div>
